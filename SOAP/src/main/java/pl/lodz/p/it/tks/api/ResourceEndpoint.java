...
import pl.lodz.p.it.tks.adapters.ResourceSoapAdapter;
import pl.lodz.p.it.tks.soap.*;

@Endpoint
public class ResourceEndpoint {
    private static final String NAMESPACE_URI = "http://www.soap.tks.it.p.lodz.pl";
